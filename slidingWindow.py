...
imgResu.save('ImagesSliding/imageResuSlidingWindow.png')
cv2.imwrite('ImagesSliding/image072withRedRect.png', img72)  # u can use just cv2.show()
cv2.imwrite('ImagesSliding/image092withGreenRect.png', img92)  # u can use just cv2.show()
sys.exit()